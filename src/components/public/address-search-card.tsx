...
export function AddressSearchCard({
  ...
  return (
    <div
      className={cn(
        "w-64 max-w-[min(70vw,26rem)] overflow-hidden rounded-lg border border-map-overlay-border bg-map-overlay text-map-overlay-foreground shadow-[var(--shadow-soft)]",
        className,
      )}
    >
      <MapCardHeader
