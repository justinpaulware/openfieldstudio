...
export function MapTitleCard({
  ...
  return (
    <div
      className={cn(
        "w-fit min-w-[17rem] max-w-[min(50vw,26rem)] rounded-lg border border-map-overlay-border bg-map-overlay p-3 text-map-overlay-foreground shadow-[var(--shadow-soft)]",
        className,
      )}
    >
